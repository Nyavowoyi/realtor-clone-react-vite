    ...
    <section>
      ...
      <div className="flex flex-wrap justify-center items-center px-6 py-12 max-w-6xl mx-auto ">
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form className="">
            <input className="w-full mb-6 px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out" type="text" id="name" placeholder="Full name" value={name} onChange={onChange} />
            ...
            <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
              <p className="mb-6">Already have an account? <Link to="/sign-in" className="text-red-600 hover:text-red-700 transition duration-200 ease-in-out ml-1">Register</Link></p>
